...
check("nivel", htmlPf2e.includes("VGP.Detail.Level"));
check("volumen", htmlPf2e.includes("VGP.Detail.Bulk"));
check("no ensena peso de 5e", !htmlPf2e.includes("VGP.Detail.Weight"));
check("cantidad", htmlPf2e.includes("VGP.Detail.Quantity"));
...
check("peso", htmlDnd.includes("VGP.Detail.Weight"));
check("sin nivel de PF2e", !htmlDnd.includes("VGP.Detail.Level"));
check("propiedad traducida", htmlDnd.includes("Sutil"));
check("cantidad 1 no se ensena", !htmlDnd.includes("VGP.Detail.Quantity"));
...
check("aviso de sin descripcion", htmlPelado.includes("VGP.Detail.NoDescription"));
check("sin bloque de precio", !htmlPelado.includes("vgp-detail-price"));
check("sin rasgos", !htmlPelado.includes("vgp-detail-tags"));
check("boton de ficha siempre", htmlPelado.includes("VGP.Detail.OpenSheet"));
...
check("con destinatario", conCompra.includes("data-vgp-detail=\"take\""));
check("sin destinatario", !htmlPelado.includes("data-vgp-detail=\"take\""));
